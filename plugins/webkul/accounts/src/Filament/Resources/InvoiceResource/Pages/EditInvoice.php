...
use Webkul\DinxCommerce\Filament\Admin\Actions\GeneratePayPalLinkAction;
use Webkul\DinxCommerce\Filament\Admin\Actions\OpenContractAction;
...
class EditInvoice extends EditRecord
{
    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            GeneratePayPalLinkAction::make(),
            OpenContractAction::make(),

		...
		<div class="container max-w-6xl mx-auto">
			<div class="grid grid-cols-1 gap-8 md:grid-cols-3">
				...
				<div class="md:col-span-1">
					...
					<p class="mb-4 text-gray-700">
						DINX ERP is designed to optimize and streamline business operations for growing teams and enterprise workflows.
					</p>
			...
			<div class="flex flex-col justify-between pt-8 mt-8 border-t border-gray-200 md:flex-row">
				<div class="text-sm text-gray-600">
					Copyright © <a href="https://dinxsolutions.com/" class="text-primary-500" target="_blank">DINX ERP</a>
				</div>
